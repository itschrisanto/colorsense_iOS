...
struct LaumaClip: View {
    enum Clip {
        ...
        case naming
        /// She skips in and lands in a celebration, then holds it. Used on the `keep` beat.
        case keep
        ...
        var stand: [(x: CGFloat, width: CGFloat, bottom: CGFloat)] {
            ...
            case .keep:
                return [
                    (0.3952, 0.7641, 0.9082), (0.4186, 0.7255, 0.9166), (0.4207, 0.7297, 0.9239),
                    (0.4207, 0.7738, 0.9239), (0.4076, 0.8110, 0.9239), (0.4159, 0.8331, 0.8321),
                    (0.4159, 0.8331, 0.8342), (0.4600, 0.8138, 0.7654), (0.5152, 0.7917, 0.8311),
                    (0.5752, 0.7241, 0.9135), (0.5738, 0.7241, 0.9135), (0.5545, 0.6303, 0.9155),
                    (0.5138, 0.7641, 0.9208), (0.5034, 0.7848, 0.9208), (0.4834, 0.8166, 0.9197),
                    (0.4772, 0.8262, 0.9187), (0.4724, 0.8359, 0.9187), (0.4676, 0.8455, 0.9155),
                    (0.4655, 0.8469, 0.9145), (0.4662, 0.8455, 0.9155), (0.4655, 0.8441, 0.9155),
                    (0.4648, 0.8428, 0.9155), (0.4641, 0.8386, 0.9166), (0.4641, 0.8276, 0.9176),
                    (0.4634, 0.8290, 0.9176), (0.4634, 0.8290, 0.9176), (0.4634, 0.8290, 0.9176),
                    (0.4634, 0.8290, 0.9166), (0.4634, 0.8290, 0.9166), (0.4634, 0.8290, 0.9176),
                ]
            }
        }
    }
